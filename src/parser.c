...
#endif
#define ParseARG_SDECL  Context * context ;
#define ParseARG_PDECL , Context * context 
#define ParseARG_PARAM ,context 
#define ParseARG_FETCH  Context * context =yypParser->context ;
